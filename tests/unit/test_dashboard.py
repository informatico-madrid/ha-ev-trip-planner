...
# ============================================================================
# Merged from test_dashboard_cover.py — I/O and executor tests
# ============================================================================


def test_read_write_file(tmp_path):
    """Executes _write_file_content and _read_file_content."""
    from custom_components.ev_trip_planner.dashboard import (
        _read_file_content,
        _write_file_content,
    )
...
# ============================================================================
# Merged from test_dashboard_missing.py — TestDashboardMissingCoverage class
# ============================================================================
...
# ============================================================================
# Merged from test_dashboard_coverage_missing.py — single test
# ============================================================================


@pytest.mark.asyncio
async def test_import_dashboard_yaml_other_result(monkeypatch):
    """import_dashboard returns failure result for any other result type from YAML fallback.

    Covers the "Any other result is a failure" branch.
    """
