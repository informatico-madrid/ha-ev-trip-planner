...
class TestCoordinatorChargingPowerFromOptions:
    ...
    def test_options_charging_power_not_used_by_coordinator(
        self, mock_hass, mock_config_entry, mock_trip_manager
    ):
    ...
    def test_data_charging_power_used_as_fallback(
        self, mock_hass, mock_config_entry, mock_trip_manager
    ):
    ...
    def test_options_takes_precedence_over_data(
        self, mock_hass, mock_config_entry, mock_trip_manager
    ):
...
class TestCoordinatorNoDefaultPower:
    ...
    def test_no_charging_power_returns_empty_attributes(
        self, mock_hass, mock_config_entry, mock_trip_manager
    ):
        ...
        assert (
            per_trip == {}
            or per_trip.get("trip1", {}).get("power_watts") is None
            or per_trip.get("trip1", {}).get("power_watts", 0) == 0
        ), (
