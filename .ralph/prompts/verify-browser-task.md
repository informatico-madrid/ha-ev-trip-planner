...
## Important Notes
- Be strict about quality and completeness
- Reject if any requirement is not fully satisfied
- Look for actual evidence of task completion, not just code presence
- Verify the task checkbox is marked [x] in tasks.md
