...
@pytest.mark.skip(reason="Batch processing arrays feature — requires def_start_timestep_array in cache entries")
        ...
        trips_creation_order = [
            {
                "id": "trip_sunday",
                "tipo": "recurring",
                "dia_semana": "domingo",  # Domingo - ÚLTIMO cronológico
                "hora": "09:40",
                "kwh": 7.0,
            ...
            },
            {
                "id": "trip_thursday_2",
                "tipo": "recurring",
                "dia_semana": "jueves",  # Jueves tarde
                "hora": "13:40",
                "kwh": 7.0,
            ...
            },
            {
                "id": "trip_thursday_1",
                "tipo": "recurring",
                "dia_semana": "jueves",  # Jueves mañana
                "hora": "09:40",
                "kwh": 7.0,
            ...
            },
            {
                "id": "trip_wednesday",
                "tipo": "recurring",
                "dia_semana": "miércoles",  # Miércoles - PRIMER cronológico
                "hora": "16:40",
                "kwh": 7.0,
