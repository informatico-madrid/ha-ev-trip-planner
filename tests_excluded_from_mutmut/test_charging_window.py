...
@pytest.mark.skip(reason="Batch processing feature (TDD test) — requires full _populate_per_trip_cache_entry with multi-trip windows")
...
@pytest.mark.skip(reason="Batch processing feature (TDD test) — requires def_start/def_end timestep arrays")
...
@pytest.mark.skip(reason="Batch processing feature (TDD test) — requires full multi-trip batch computation")
