...
Playwright Browser Automation
    ↓
Navegar a http://192.168.1.100:8123/
    ↓
...
1. **Given** Home Assistant está accesible en http://192.168.1.100:8123/, **When** ejecuto el script de Playwright, **Then** el script navega a la página de login
...
- **FR-001**: El sistema DEBE permitir navegar con Playwright a http://192.168.1.100:8123/
...
1. Se asume que Home Assistant está ejecutándose en http://192.168.1.100:8123/
...
// Navegar a HA
await page.goto('http://192.168.1.100:8123/');
...
// Navegar a integraciones
await page.goto('http://192.168.1.100:8123/config/integrations');
...
// Navegar al panel
await page.goto('http://192.168.1.100:8123/panel/ev-trip-planner-test-vehicle');
```
...
- **Q: ¿Qué URL de Home Assistant se usa?**
  → **A: http://192.168.1.100:8123/** (URL local del entorno de desarrollo)
